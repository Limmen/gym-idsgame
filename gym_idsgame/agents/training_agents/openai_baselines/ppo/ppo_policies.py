...
from gym_idsgame.agents.training_agents.openai_baselines.common_policies import (BasePolicy, register_policy, MlpExtractor,
                                                                                 create_sde_features_extractor, NatureCNN,
                                                                                 BaseFeaturesExtractor, FlattenExtractor)
from gym_idsgame.agents.training_agents.openai_baselines.distributions import (make_proba_distribution, Distribution,
...
class PPOPolicy(BasePolicy):
    ...
    def forward(self, obs: th.Tensor, env : IdsGameEnv,
                deterministic: bool = False, device: str = "cuda") -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        """
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor, latent_sde: Optional[th.Tensor] = None,
        ...
        if non_legal_actions is not None and len(non_legal_actions) > 0:
            action_probs_1[non_legal_actions] = 0.00000001
