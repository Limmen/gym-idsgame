...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs, attacker_observation_space, attacker_action_space,
    ...
    def step(self, actions, update_stats = False):
        """
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(self, venv, attacker_observation_space=None, attacker_action_space=None):
        self.venv = venv
