# Experiment `minimal_defense-v13`_`manual_attacker`
...
```json
{
    ...
    "logger": null,
    "mode": 3,
    "output_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/manual_play/v13/minimal_defense/manual_vs_minimal_defense",
