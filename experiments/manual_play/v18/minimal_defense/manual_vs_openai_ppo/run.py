...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=1, alpha_attacker=0.00001, epsilon=1, render=False,
                                                ...
                                                attacker_load_path="/Users/kimham/workspace/rl/gym-idsgame/experiments/manual_play/v18/minimal_defense/manual_vs_openai_ppo/1591026548.0497508_attacker_policy_network.zip")
