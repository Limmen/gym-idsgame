# Experiment `maximal_attack-v18`_`manual_attacker`

This is an experiment in the `maximal_attack-v18` environment. 
...
```json
{
    ...
    "logger": null,
    "mode": 4,
    "output_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/manual_play/v18/maximal_attack/maximal_vs_manual",
