# Experiment `random_attack-v3`_`manual_defender`
...
```json
{
    ...
    "logger": null,
    "mode": 4,
    "output_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/manual_play/v3/random_attack/random_vs_manual",
