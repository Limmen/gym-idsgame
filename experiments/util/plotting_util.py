...
def plot_results(avg_episode_rewards: np.ndarray = None, avg_episode_steps: np.ndarray = None,
                 ...
                 defender_cumulative_reward: np.ndarray = None, log_frequency: int = None, output_dir: str = None,
    ...
    if defender_cumulative_reward is not None:
        simple_line_plot(np.array(list(range(len(defender_cumulative_reward)))) * log_frequency,
