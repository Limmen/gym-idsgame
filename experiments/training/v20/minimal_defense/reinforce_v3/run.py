...
def default_config() -> ClientConfig:
    ...
    env_name = "idsgame-minimal_defense-v20"
    client_config = ClientConfig(env_name=env_name, attacker_type=AgentType.REINFORCE_AGENT.value,
                                 ...
                                 run_many=False, random_seeds=[0, 999, 299, 399, 499], random_seed=299)
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("reinforce_vs_minimal_defense-v20", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
