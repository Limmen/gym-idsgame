# Experiment `minimal_defense-v9`_`reinforce`
...
```json
{
    ...
    "logger": null,
    "mode": 5,
    "output_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/two_agents/reinforce",
    "pg_agent_config": {
        "alpha": 1e-05,
        ...
        "eval_sleep": 0.9,
        "gamma": 0.999,
        "gif_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/two_agents/reinforce/results/gifs",
        "gifs": true,
        "gpu": false,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/two_agents/reinforce/results/data",
        "state_length": 1,
        "tensorboard": true,
        "tensorboard_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/two_agents/reinforce/results/tensorboard",
        "train_log_frequency": 100,
        "video": true,
        "video_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/two_agents/reinforce/results/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
...
pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha=0.00001, epsilon=1, render=False, eval_sleep=0.9,
                                                ...
                                                checkpoint_freq=5000, input_dim=44, output_dim_attacker=40,
                                                output_dim_defender=44,
                                                hidden_dim=64,
