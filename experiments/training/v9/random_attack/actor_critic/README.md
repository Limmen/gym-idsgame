# Experiment `random_attack-v9`_`actor_critic`
...
```json
{
    ...
    "logger": null,
    "mode": 1,
    "output_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/random_attack/actor_critic",
    "pg_agent_config": {
        "alpha": 1e-05,
        ...
        "eval_sleep": 0.9,
        "gamma": 0.999,
        "gif_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/random_attack/actor_critic/results/gifs",
        "gifs": true,
        "gpu": false,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/random_attack/actor_critic/results/data",
        "state_length": 4,
        "tensorboard": true,
        "tensorboard_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/random_attack/actor_critic/results/tensorboard",
        "train_log_frequency": 100,
        "video": true,
        "video_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v9/random_attack/actor_critic/results/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
...
pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha=0.00001, epsilon=1, render=False, eval_sleep=0.9,
                                                ...
                                                checkpoint_freq=5000, input_dim=44*4, output_dim_defender=44, hidden_dim=64,
