...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=1, alpha_attacker=0.0001, epsilon=1, render=False,
                                                ...
                                                eval_frequency=35000, attacker=True, defender=False,
                                                ...
                                                flatten_feature_planes=False, cnn_type=5, vf_coef=0.5, ent_coef=0.0005,
                                                ...
                                                channel_1_dim=64, channel_1_layers=1, channel_1_input_dim=16,
                                                channel_2_dim=64, channel_2_layers=1, channel_2_input_dim=16,
                                                ...
                                                node_net_multi_channel=True, at_net_multi_channel=False,
                                                node_net_lstm_core=False, at_net_lstm_core=False)
