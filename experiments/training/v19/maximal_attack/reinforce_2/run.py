...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha_attacker=0.00001,
                                                alpha_defender=0.000005, epsilon=1, render=False, eval_sleep=0.9,
                                                ...
                                                num_episodes=200000001,
                                                eval_render=False, gifs=True,
                                                gif_dir=default_output_dir() + "/results/gifs",
                                                eval_frequency=10000000000, attacker=False, defender=True, video_frequency=101,
