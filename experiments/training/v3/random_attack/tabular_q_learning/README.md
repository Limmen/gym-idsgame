# Experiment `random_attack-v3`_`tabular_q_learning`
...
```json
{
    ...
    "q_agent_config": {
        ...
        "eval_sleep": 0.9,
        "gamma": 0.99,
        "gif_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/training/v3/random_attack/tabular_q_learning/gifs",
        "gifs": true,
        "load_path": null,
        "logger": null,
        "min_epsilon": 0.01,
