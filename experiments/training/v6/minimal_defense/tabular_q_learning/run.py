...
def default_config() -> ClientConfig:
    ...
    """
    q_agent_config = QAgentConfig(gamma=0.999, alpha=0.05, epsilon=0.4, render=False, eval_sleep=0.9,
...
if __name__ == '__main__':
    ...
    logger = util.setup_logger("tabular_q_learning_vs_minimal_defense-v5", config.output_dir + "/logs/",
                               time_str=time_str)
