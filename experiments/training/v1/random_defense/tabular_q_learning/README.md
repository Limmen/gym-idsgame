# Experiment `random_defense-v1`_`tabular_q_learning`
...
```json
{
    ...
    "logger": null,
    "mode": 0,
    "output_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/training/v1/random_defense/tabular_q_learning",
    ...
    "q_agent_config": {
        ...
        "eval_sleep": 0.9,
        "gamma": 0.9,
        "gif_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/training/v1/random_defense/tabular_q_learning/gifs",
        "gifs": true,
        "load_path": null,
        "logger": null,
        "min_epsilon": 0.1,
        ...
        "render": false,
        "save_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/training/v1/random_defense/tabular_q_learning/data",
        "train_log_frequency": 10,
        "video": true,
        "video_dir": "/home/kim/storage/workspace/gym-idsgame/experiments/training/v1/random_defense/tabular_q_learning/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
...
q_agent_config = QAgentConfig(gamma=0.9, alpha=0.05, epsilon=1, render=False, eval_sleep=0.9,
                              min_epsilon=0.1, eval_episodes=100, train_log_frequency=10,
