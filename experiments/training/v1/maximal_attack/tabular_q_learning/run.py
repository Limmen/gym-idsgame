...
def default_config() -> ClientConfig:
    ...
    q_agent_config = QAgentConfig(gamma=0.999, alpha=0.2, epsilon=1, render=False, eval_sleep=0.9,
                                  ...
                                  video_fps=5, video_dir=default_output_dir() + "/videos", num_episodes=300000,
                                  eval_render=False, gifs=True, gif_dir=default_output_dir() + "/gifs",
                                  eval_frequency=20000, attacker=False, defender=True,
...
if __name__ == '__main__':
    ...
    logger = util.setup_logger("maximal_attack_vs_tabular_q_learning-v1", config.output_dir + "/logs/",
                               time_str=time_str)
