...
def default_config() -> ClientConfig:
    ...
    """
    dqn_config = DQNConfig(input_dim=33, defender_output_dim=33, hidden_dim=64, replay_memory_size=10000,
                           num_hidden_layers=1,
...
def plot_average_results(experiment_title :str, config: ClientConfig, eval_csv_paths:list,
    ...
    plotting_util.read_and_plot_average_results(experiment_title, train_csv_paths, eval_csv_paths,
                                                ...
                                                config.output_dir,
                                                plot_attacker_loss = False, plot_defender_loss = True)
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("random_attack_vs_dqn-v8", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
...
if __name__ == '__main__':
    ...
    experiment_title = "random attack vs Q-learning"
