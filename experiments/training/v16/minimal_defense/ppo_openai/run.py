...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=1, alpha_attacker=0.00001, epsilon=1, render=False,
                                                ...
                                                input_dim_attacker = (6, 3, 4),
                                                output_dim_attacker = 4 * 3,
                                                input_dim_defender = (6, 3, 4),
                                                ...
                                                cnn_feature_extractor=True, features_dim=512,
                                                flatten_feature_planes=False, cnn_type=5)
    ...
    # input_dim_defender = (6, 3, 4),
    # output_dim_defender = 5 * 3,
    # input_dim_attacker = 72,
    # output_dim_attacker = 4 * 3,
    # input_dim_defender = 72,
    # output_dim_defender = 5 * 3,
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("openai-ppo_vs_minimal_defense-v16", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
