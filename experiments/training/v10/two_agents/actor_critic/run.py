...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha=0.001, epsilon=1, render=False, eval_sleep=0.9,
                                                min_epsilon=0.01, eval_episodes=100, train_log_frequency=200,
                                                ...
                                                checkpoint_freq=10000, input_dim=33*2, output_dim_attacker=30,
                                                output_dim_defender=33,
                                                hidden_dim=32,
                                                num_hidden_layers=1, batch_size=64,
                                                gpu=False, tensorboard=True,
                                                tensorboard_dir=default_output_dir() + "/results/tensorboard",
                                                optimizer="Adam", lr_exp_decay=False, lr_decay_rate=0.999,
                                                state_length=1, opponent_pool=True, alternating_optimization=True,
                                                alternating_period=100,
