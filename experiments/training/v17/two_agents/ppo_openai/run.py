...
def default_config() -> ClientConfig:
    ...
    """
    pg_agent_config = PolicyGradientAgentConfig(gamma=1, alpha_attacker=0.0001, alpha_defender=0.0001,
                                                epsilon=1, render=False,
                                                eval_sleep=0.9,
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("openai-ppo_vs_openai-ppo-v17", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
...
if __name__ == '__main__':
    ...
    experiment_title = "OpenAI-PPO vs OpenAI-PPO"
