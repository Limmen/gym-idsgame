...
def default_config() -> ClientConfig:
    ...
    pg_agent_config = PolicyGradientAgentConfig(gamma=1, alpha_attacker=0.0001, epsilon=1, render=False,
                                                ...
                                                input_dim_attacker=(3,4,3),
                                                output_dim_attacker=4 * 3,
                                                input_dim_defender=(3,4,3),
                                                ...
                                                cnn_feature_extractor=True)
    # input_dim_attacker = ((4 + 1) * 3),
    # output_dim_attacker = 4 * 3,
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("openai-ppo_vs_minimal_defense-v17", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
