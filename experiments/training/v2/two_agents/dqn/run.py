...
def default_config() -> ClientConfig:
    ...
    """
    dqn_config = DQNConfig(input_dim=44, defender_output_dim=44, attacker_output_dim=40,
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("dqn_vs_minimal_defense-v2", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
