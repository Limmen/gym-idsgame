# Experiment `minimal_defense-v14`_`actor_critic`
...
```json
{
    ...
    "logger": null,
    "mode": 0,
    "output_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v14/minimal_defense/actor_critic",
    "pg_agent_config": {
        ...
        "eval_sleep": 0.9,
        "gamma": 0.999,
        "gif_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v14/minimal_defense/actor_critic/results/gifs",
        "gifs": true,
        "gpu": false,
        "gpu_id": 0,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v14/minimal_defense/actor_critic/results/data",
        "state_length": 1,
        "tensorboard": true,
        "tensorboard_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v14/minimal_defense/actor_critic/results/tensorboard",
        "train_log_frequency": 100,
        "video": true,
        "video_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v14/minimal_defense/actor_critic/results/videos",
        "video_fps": 5,
        "video_frequency": 101,
...
pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha_attacker=0.001, epsilon=1, render=False, eval_sleep=0.9,
                                                ...
                                                checkpoint_freq=15000, input_dim_attacker=(4 + 3) * 2, output_dim_attacker=4 * 2,
                                                hidden_dim=36,
