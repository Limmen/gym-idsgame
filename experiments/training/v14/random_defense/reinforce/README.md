# Experiment `random_defense-v14`_`reinforce`
...
```json
{
    ...
    "logger": null,
    "mode": 0,
    "output_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v8/random_defense/reinforce",
    "pg_agent_config": {
        "alpha": 1e-05,
        "attacker": true,
        ...
        "eval_sleep": 0.9,
        "gamma": 0.999,
        "gif_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v8/random_defense/reinforce/results/gifs",
        "gifs": true,
        "gpu": false,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v8/random_defense/reinforce/results/data",
        "tensorboard": true,
        "tensorboard_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v8/random_defense/reinforce/results/tensorboard",
        "train_log_frequency": 100,
        "video": true,
        "video_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v8/random_defense/reinforce/results/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
    ...
    "title": "TrainingREINFORCEAgent vs DefendrandomDefender"
}
```
...
pg_agent_config = PolicyGradientAgentConfig(gamma=0.999, alpha_attacker=0.001, epsilon=1, render=False, eval_sleep=0.9,
                                                ...
                                                checkpoint_freq=5000, input_dim=(4+3)*2, output_dim_attacker=4*2,
                                                hidden_dim=32,
