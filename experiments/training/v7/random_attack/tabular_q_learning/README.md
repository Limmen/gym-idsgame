# Experiment `random_attack-v7`_`tabular_q_learning`
...
```json
{
    ...
    "logger": null,
    "mode": 1,
    "output_dir": "/Users/kimham/workspace/rl/gym-idsgame/experiments/training/v7/random_attack/tabular_q_learning",
    ...
    "q_agent_config": {
        ...
        "eval_sleep": 0.9,
        "gamma": 0.999,
        "gif_dir": "/Users/kimham/workspace/rl/gym-idsgame/experiments/training/v7/random_attack/tabular_q_learning/results/gifs",
        "gifs": false,
        "logger": null,
        "min_epsilon": 0.01,
        "num_episodes": 20001,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/Users/kimham/workspace/rl/gym-idsgame/experiments/training/v7/random_attack/tabular_q_learning/results/data",
        "train_log_frequency": 1,
        "video": false,
        "video_dir": "/Users/kimham/workspace/rl/gym-idsgame/experiments/training/v7/random_attack/tabular_q_learning/results/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
    "random_seeds": [
...
```python
q_agent_config = QAgentConfig(gamma=0.9999, alpha=0.0005, epsilon=1, render=False, eval_sleep=0.9,
