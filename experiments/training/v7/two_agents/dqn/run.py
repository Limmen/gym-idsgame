...
def default_config() -> ClientConfig:
    ...
    """
    dqn_config = DQNConfig(input_dim=88, attacker_output_dim=80, defender_output_dim=88,
...
def run_experiment(configpath: str, random_seed: int, noconfig: bool):
    ...
    logger = util.setup_logger("dqn_vs_random_defense-v7", config.output_dir + "/results/logs/" +
                               str(random_seed) + "/",
                               time_str=time_str)
