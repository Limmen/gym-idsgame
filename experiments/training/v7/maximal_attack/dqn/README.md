# Experiment `maximal_attack-v7`_`dqn`
...
```json
{
    ...
    "logger": null,
    "mode": 0,
    "output_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v7/maximal_attack/dqn",
    ...
    "q_agent_config": {
        ...
        "dqn_config": {
            ...
            "tensorboard": true,
            "tensorboard_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v7/maximal_attack/dqn/results/tensorboard"
        },
        "epsilon": 1,
        "epsilon_decay": 0.999,
        "eval_episodes": 100,
        ...
        "eval_sleep": 0.9,
        "gamma": 0.99,
        "gif_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v7/maximal_attack/dqn/results/gifs",
        "gifs": true,
        "logger": null,
        "min_epsilon": 0.05,
        "num_episodes": 10000,
        ...
        "random_seed": 0,
        "render": false,
        "save_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v7/maximal_attack/dqn/results/data",
        "train_log_frequency": 100,
        "video": true,
        "video_dir": "/media/kim/HDD/workspace/gym-idsgame/experiments/training/v7/maximal_attack/dqn/results/videos",
        "video_fps": 5,
        "video_frequency": 101
    },
    "random_seeds": [
